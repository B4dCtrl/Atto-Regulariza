...
const GlassButton = React.forwardRef<HTMLButtonElement, GlassButtonProps>(
  ({ className, children, size, contentClassName, glassColor, ...props }, ref) => {
    // Unique ID so multiple buttons don't conflict with each other's SVG filters
    ...
    return (
      <>
        {/* INVISIBLE SVG FILTER DEFINITION
            ...
            stretch to ANY button size automatically, no JS needed. */}
        ...
        <button
          ...
          {...props}
        >
          {/* ISOLATED BACKGROUND LENS — must stay empty for clean refraction */}
